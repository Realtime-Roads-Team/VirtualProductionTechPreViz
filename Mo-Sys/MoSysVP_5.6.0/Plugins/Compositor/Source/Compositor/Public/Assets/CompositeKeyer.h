...
public:
	...
	// Mo-Sys changed
	/** Enable/Disable CompositeKeyer. */
	UFUNCTION(Category = "CompositeKeyer", BlueprintCallable)
	void SetKeyerEnabled(bool IsEnabled);
...
private:
	...
	TMap<int32, double*> DoubleParametersForMID;
};
