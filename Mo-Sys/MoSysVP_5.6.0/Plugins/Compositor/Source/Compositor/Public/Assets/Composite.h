...
public:
	...
	uint8 bOverride_MediaInputSource : 1;
...
private:
	...
	/** The media source used as the media input. */
	UPROPERTY(Category = "Media Input", EditAnywhere, meta = (EditCondition = "bOverride_MediaInputSource"))
	UMediaSource* MediaInputSource;
	...
	UPROPERTY(Category = "Media Keyer", VisibleInstanceOnly, Instanced, Export, meta = (EditCondition = "bOverride_MediaInputKeyer"))
...
public:
	...
	UFUNCTION(Category="Composite", BlueprintPure)
	UMediaSource* GetMediaInputSource() const;

	UFUNCTION(Category = "Composite", BlueprintCallable)
	void SetMediaInputSource(UMediaSource* NewMediaInputSource);
	...
	/** Enable input keyer.*/
	UFUNCTION(Category = "Composite", BlueprintCallable)
	void EnableMediaInputKeyer(bool IsEnabled);
