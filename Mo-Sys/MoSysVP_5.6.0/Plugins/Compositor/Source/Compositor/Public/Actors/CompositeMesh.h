...
protected:
	...
	UPROPERTY(Category = "Composite Mesh", EditDefaultsOnly, BlueprintReadOnly, meta = (AllowPrivateAccess = "true"))
	class UMaterialInterface* SoftMaskMaterial;
...
private:
	...
	UPROPERTY(Category = "Composite Mesh", BlueprintReadOnly, Transient, meta = (AllowPrivateAccess = "true"))
	class UMaterialInstanceDynamic* SoftMaskMID;
	...
	float ReceiveShadowsIntensity = 1.f;
	...
	*/
	...
	///** The blending applied to this Composite Mesh. */
	//UPROPERTY(Category = "Shading", EditAnywhere, Interp, BlueprintSetter = SetBlendMode, meta = (AllowPrivateAccess = "true"))
	//ECompositeMeshBlendMode BlendMode;
	///** Force opaque parameter. */
	//int32 OpaqueForceOpaqueParameterIndex, TranslucentForceOpaqueParameterIndex;
	///** Force masked parameter. */
	//int32 OpaqueForceMaskedParameterIndex, TranslucentForceMaskedParameterIndex;
	...
	bool bIsTwoSided;
	/** Two sided parameter. */
	int32 OpaqueTwoSidedParameterIndex, StencilTwoSidedParameterIndex, TranslucentTwoSidedParameterIndex, SoftMaskTwoSidedParameterIndex;
...
public:
	...
	UStaticMeshComponent* GetOpaqueComponent() const { return OpaqueComponent; }

	UStaticMeshComponent* GetTranslucentComponent() const { return TranslucentComponent; }

	UStaticMeshComponent* GetStencilComponent() const { return StencilComponent; }
	...
	FORCEINLINE UMaterialInstanceDynamic* GetSoftMaskMID() const { return SoftMaskMID; };
	...
	FORCEINLINE bool GetRenderSoftMask() const { return bRenderSoftMask; };
	UFUNCTION(BlueprintSetter, meta = (CallInEditor = "true"))
	void SetRenderSoftMask(const bool bNewRenderSoftMask);
