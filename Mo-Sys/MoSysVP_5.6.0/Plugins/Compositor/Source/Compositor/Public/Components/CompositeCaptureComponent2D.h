...
public:
	...
	virtual void ViewportResizeCallback(FViewport* Viewport, uint32 Unused);
...
public:
	...
	void UpdateSceneCaptureContents(FSceneInterface* Scene, ISceneRenderBuilder& SceneRenderBuilder) override;

private:
	bool TryAddCompositeViewportResizeEvent();
