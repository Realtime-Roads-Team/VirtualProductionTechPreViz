	...
	if (FirstObjectBeingCustomized)
	{
		...
		if (IsValid(World))
		{
			...
			if (IsValid(CompositorSubsystem))
			{
				...
				CompositorSubsystem->OnCompositeWorldDataAdded.RemoveAll(this);
				CompositorSubsystem->OnCompositeWorldDataAdded.AddSP(this, &FCompositorWorldSettingsDetails::ForceRefreshDetails);

				CompositorSubsystem->OnCompositeWorldDataRemoved.RemoveAll(this);
				CompositorSubsystem->OnCompositeWorldDataRemoved.AddSP(this, &FCompositorWorldSettingsDetails::ForceRefreshDetails);
			}
		}
	}
}
